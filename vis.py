...
img_0 = tifffile.imread(os.path.join(sys.path[0],'model_snr_fill/snr5_sd0_dec128.tif'))
img_1 = tifffile.imread(os.path.join(sys.path[0],'model_snr_fill/snr10_sd0_dec128.tif'))
img_2 = tifffile.imread(os.path.join(sys.path[0],'model_snr_fill/snr20_sd0_dec128.tif'))
img_3 = tifffile.imread(os.path.join(sys.path[0],'model_snr_fill/snr5_sd0_dec512.tif'))
img_4 = tifffile.imread(os.path.join(sys.path[0],'model_snr_fill/snr10_sd0_dec512.tif'))
img_5 = tifffile.imread(os.path.join(sys.path[0],'model_snr_fill/snr20_sd0_dec512.tif'))
...
slice_3.set_clim(vmin=0, vmax=4200) 
...
slice_4.set_clim(vmin=0, vmax=4200) 
...
slice_5.set_clim(vmin=0, vmax=4200) 
