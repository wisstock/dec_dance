...
img_0 = tifffile.imread(os.path.join(sys.path[0],'model_snr_circ/conv_snr20_sd2.tif'))
img_1 = tifffile.imread(os.path.join(sys.path[0],'model_snr_fill/snr10_sd10_dec128.tif'))
img_2 = tifffile.imread(os.path.join(sys.path[0],'model_snr_fill/snr20_sd10_dec128.tif'))
img_3 = tifffile.imread(os.path.join(sys.path[0],'model_snr_fill/snr5_sd10_dec512.tif'))
img_4 = tifffile.imread(os.path.join(sys.path[0],'model_snr_fill/snr10_sd5_dec512.tif'))
img_5 = tifffile.imread(os.path.join(sys.path[0],'model_snr_fill/snr20_sd5_dec512.tif'))
