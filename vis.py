...
img_0 = tifffile.imread(os.path.join(sys.path[0],'model_snr/snr10_sd20.0_dec128.tif'))
img_1 = tifffile.imread(os.path.join(sys.path[0],'model_snr/snr30_sd20.0_dec128.tif'))
img_2 = tifffile.imread(os.path.join(sys.path[0],'model_snr/snr50_sd20.0_dec128.tif'))
img_3 = tifffile.imread(os.path.join(sys.path[0],'model_snr/snr10_sd20.0_dec512.tif'))
img_4 = tifffile.imread(os.path.join(sys.path[0],'model_snr/snr30_sd20.0_dec512.tif'))
img_5 = tifffile.imread(os.path.join(sys.path[0],'model_snr/snr50_sd20.0_dec512.tif'))
